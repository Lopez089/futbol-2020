// extraer de cada partido la hora
// index con todas las ligas con los numero
// imprimir en el index los datos de la app
// un formulario con un boton
//segun el numero que ponga es la loga que me da
// crear un exel para copiarlos partido y horarios
// testear los algunos partidos
var hola = "mas"
module.exports.holas = hola ;

// extraer partidos y url
var request = require('request');
const cheerio = require('cheerio');

console.log('hola')
module.exports = contador = 11;
...
var direcionBase = "https://es.soccerway.com"

request(ligas[contador], function (error, response, body) {
  
    let $ = cheerio.load(body);
  	
  	var equipos = $(`.matches .match`).toArray()
   	.map(equipo => {
   		const $equipo = $(equipo)
   		...
   		return {
			...
			}//var i =$(".score-time").has('.status')find("a").attr("href")
